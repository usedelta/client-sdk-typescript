...
export class Customers {
     ...
     */
    public async getCustomers(requestOptions?: Customers.RequestOptions): Promise<DeltaApi.Customer> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "customers"),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return await serializers.Customer.parseOrThrow(_response.body, {
    ...
    public async getCustomerById(
        customerId: DeltaApi.CustomerId,
        requestOptions?: Customers.RequestOptions
    ): Promise<DeltaApi.Customer> {
        const _response = await core.fetcher({
            url: urlJoin(
                await core.Supplier.get(this._options.environment),
                `customers/${await serializers.CustomerId.jsonOrThrow(customerId)}`
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
