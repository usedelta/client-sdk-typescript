...
export interface ProductVariantsItem {
    ...
    pricingDetails?: UsedeltaApi.ProductVariantsItemPricingDetails;
    /** The country of origin of the item. (ISO 3166-1) */
    countryOfOrigin?: string;
    customs?: UsedeltaApi.ProductVariantsItemCustoms;
    /** The total stock of the item. */
    totalStock?: number;
    /** The unit type of the item. */
    unitType?: UsedeltaApi.ProductVariantsItemUnitType;
    ...
    dimensions?: UsedeltaApi.ProductVariantsItemDimensions;
    /** The media files of the item. */
    media?: UsedeltaApi.ProductVariantsItemMedia;
    /** The individual tags or attributes of the item. */
    tags?: UsedeltaApi.ProductVariantsItemTags;
