...
export interface Order {
    ...
    status?: UsedeltaApi.OrderStatus;
    /** Payment status of the order on the connected platform. */
    paymentStatus?: UsedeltaApi.OrderPaymentStatus;
    ...
    fulfillmentStatus?: UsedeltaApi.OrderFulfillmentStatus;
    ...
    billingAddress?: UsedeltaApi.OrderBillingAddress;
    /** Billing address for the order */
    shippingAddress?: UsedeltaApi.OrderShippingAddress;
    /** Items of the order */
    lineItems?: UsedeltaApi.OrderLineItemsItem[];
    ...
    fulfillments?: UsedeltaApi.Fulfillment[];
}
